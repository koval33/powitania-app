...
app.get('/cennik/', (req, res) => {
  res.render('cennik', {
    ...
    description: 'Cennik nagrań lektorskich: reklama od 300 zł, narracja od 340 zł/A4, IVR od 380 zł. Realizacja 24-48h, ponad 200 lektorów. Bezpłatna próbka na życzenie.'
  });
});

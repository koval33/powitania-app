...
// EUR do wyswietlania na EN: kurs i zaokraglenie W GORE do 5 EUR - identycznie jak
// plnToEur() w server.js (bank glosow EN). Platnosc i tak idzie w PLN (P24).
const EUR_RATE = 4.20;
...
const PAKIETY = [
  {
    ...
    metaDescriptionEn: 'Phone announcement recording package: up to 3 IVR messages, up to 100 words in total, voice from our bank, perpetual licence, 48h delivery. EUR 95 net, online payment.',
  ...
  },
  {
    ...
    metaDescriptionEn: 'PRO package: up to 5 IVR messages, up to 200 words in total, background music included, 72h delivery. EUR 145 net, online payment.',
  ...
  },
  {
    ...
    metaDescriptionEn: '30-second radio spot with a 12-month broadcast licence for a nationwide station. EUR 215 net, online payment.',
...
function getOrderVoices(voices, pakiet) {
  const arr = voices.filter(v => v.approved !== false);
  let pool;

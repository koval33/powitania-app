...
// EUR sluzy WYLACZNIE do wyswietlania na stronach EN (spojnie z bankiem glosow).
// Platnosc idzie zawsze w PLN: do P24 wysylamy pakiet.netto (PLN), a na stronie
// jawnie podajemy kwote brutto w PLN, ktora realnie pobieramy.
// Ta sama regula co plnToEur() w server.js: kurs 4.20, zaokraglenie W GORE do 5 EUR.
const EUR_RATE = 4.20;
const eurCeil = (netto) => Math.ceil((netto / EUR_RATE) / 5) * 5;
...
const FOREIGN_SAMPLE = /języku (?!angielskim)|rumuńsk|niemieck|francusk|hiszpańsk|ukraińsk|rosyjsk|czesk|słowack|włosk/i;
...
const PAKIETY = [
  {
    ...
    metaDescriptionEn: 'Phone announcement recording package: up to 3 IVR messages, up to 100 words in total, voice from our bank, perpetual licence, 48h delivery. EUR 95 net, payment processed in PLN.',
    ...
    feedTitle: 'Nagranie zapowiedzi telefonicznej IVR - pakiet START (3 komunikaty, do 100 słów, 48h)',
    ...
    scope: [
      ...
      'łącznie do 100 słów',
      'trzy wersje interpretacyjne nagrania do wyboru',
    ...
    scopeEn: [
      ...
      'three interpretation takes of the recording to choose from',
    ...
    faq: [
      ...
      { q: 'Nie mam jeszcze tekstu. Co teraz?', a: 'Przygotujesz go w kilka minut w naszym <a href="/kreator/?start=ivr" class="text-accent hover:underline">kreatorze treści</a> - wybierasz typ zapowiedzi i dostajesz gotowy tekst do akceptacji. Możesz też dosłać tekst po zamówieniu.' },
      { q: 'Co jeśli potrzebuję więcej niż 3 komunikaty?', a: 'Wybierz pakiet PRO (do 5 komunikatów, do 200 słów) albo MAX PL+EN (do 10 komunikatów). Przy nietypowych potrzebach wypełnij <a href="/kontakt/#formularz" class="text-accent hover:underline">formularz wyceny</a> - odpowiadamy w 2 godziny w dni robocze.' }
    ],
    faqEn: [
      ...
      { q: 'I do not have a script yet. What now?', a: 'Draft one in minutes with our free <a href="/en/kreator/" class="text-accent hover:underline">script creator</a> - pick the announcement type and get a ready text. You can also send the script after ordering.' },
      { q: 'What if I need more than 3 messages?', a: 'Choose the PRO package (up to 5 messages, 200 words) or MAX PL+EN (up to 10 messages). For non-standard needs, use the <a href="/en/contact/#contact-form" class="text-accent hover:underline">quote form</a> - we reply within 2 business hours.' }
    ]
  },
  {
    ...
    metaDescriptionEn: 'PRO package: up to 5 IVR messages, up to 200 words in total, background music included, 72h delivery. EUR 145 net, payment processed in PLN.',
    ...
    feedTitle: 'Nagranie zapowiedzi telefonicznej IVR - pakiet PRO (5 komunikatów, muzyka, 72h)',
    ...
    faq: [
      ...
      { q: 'Czy 5 komunikatów wystarczy na całą centralę?', a: 'W większości firm tak: powitanie, menu, komunikat kolejki, poza godzinami i poczta głosowa to właśnie 5 komunikatów. Przy rozbudowanych drzewach IVR wybierz pakiet MAX albo <a href="/kontakt/#formularz" class="text-accent hover:underline">formularz wyceny</a>.' },
      { q: 'Czy mogę zmienić treść po nagraniu?', a: 'Drobne poprawki błędów po naszej stronie są bezpłatne. Zmiany treści po akceptacji dogrywamy z tym samym lektorem za drobną dopłatą - wycenimy ją od ręki mailowo.' }
    ],
    faqEn: [
      ...
      { q: 'Are 5 messages enough for a whole PBX?', a: 'For most companies yes: greeting, menu, queue message, after-hours and voicemail are exactly 5 messages. For complex IVR trees choose the MAX package or the <a href="/en/contact/#contact-form" class="text-accent hover:underline">quote form</a>.' },
      { q: 'Can I change the script after recording?', a: 'Minor fixes of our mistakes are free. Content changes after approval are re-recorded with the same voice talent for a small fee - quoted on the spot by email.' }
    ]
  },
  {
    ...
    metaDescriptionEn: 'Phone announcements in Polish and English: up to 3 messages, up to 100 words in total, each in two language versions. EUR 130 net.',
    ...
    feedTitle: 'Zapowiedzi telefoniczne dwujęzyczne PL+EN - pakiet 3 komunikaty (do 100 słów)',
    ...
    scope: [
      ...
      'lektor polski + lektor anglojęzyczny z banku głosów',
      'plik w formacie pod Twoją centralę',
      'licencja bezterminowa'
    ],
    scopeEn: [
      ...
      'Polish voice + English voice from our bank',
      'file format matched to your PBX',
      'perpetual licence'
    ],
    notIncluded: [
  ...
  },
  {
    ...
    metaDescriptionEn: 'Complete bilingual PBX set: up to 10 IVR messages, up to 500 words in total, Polish and English versions, music included. EUR 360 net.',
    ...
    feedTitle: 'Zapowiedzi telefoniczne dwujęzyczne PL+EN - pakiet MAX (10 komunikatów, 500 słów)',
    ...
    faq: [
      ...
      { q: 'Co przy zmianach treści za pół roku?', a: 'Aktualizacje istniejących komunikatów dogrywamy z tym samym lektorem, żeby całość brzmiała spójnie - drobną dopłatę wyceniamy od ręki mailowo.' }
    ],
    faqEn: [
      ...
      { q: 'What about content changes in six months?', a: 'Updates of existing messages are re-recorded with the same voice talent for consistency - the small fee is quoted on the spot by email.' }
    ]
  },
  {
    ...
    metaDescriptionEn: 'Radio spot recording: 30-second voice-over with a 12-month broadcast licence for a local station. EUR 75 net, order online.',
    ...
    feedTitle: 'Spot radiowy 30 sekund - nagranie lektorskie + licencja emisyjna, stacja lokalna',
    ...
    faq: [
      ...
      { q: 'Czy w cenie jest muzyka i montaż?', a: 'Pakiet obejmuje czyste nagranie lektorskie. Pełną produkcję spotu (muzyka, montaż, mastering) wyceniamy do projektu - opisz potrzeby w <a href="/kontakt/#formularz" class="text-accent hover:underline">formularzu wyceny</a>.' },
      { q: 'Nie mam scenariusza. Pomożecie?', a: 'Tak - nasz <a href="/kreator/?start=spots" class="text-accent hover:underline">kreator treści</a> przygotuje tekst spotu pod zadany czas emisji w kilka minut, bezpłatnie.' }
    ],
    faqEn: [
      ...
      { q: 'I have no script. Can you help?', a: 'Yes - our free <a href="/en/kreator/" class="text-accent hover:underline">script creator</a> drafts a spot script for your target duration in minutes.' }
    ]
  },
  {
    ...
    titleEn: 'Radio spot for nationwide broadcast: EUR 215 net | Powitania',
    ...
    metaDescriptionEn: '30-second radio spot with a 12-month broadcast licence for a nationwide station. EUR 215 net, payment processed in PLN.',
    ...
    feedTitle: 'Spot radiowy 30 sekund - nagranie lektorskie + licencja emisyjna, stacja ogólnopolska',
    ...
    faq: [
      ...
      { q: 'Czy jedna licencja obejmuje kilka stacji?', a: 'Licencja dotyczy jednej stacji. Przy kampanii w kilku stacjach lub sieci opisz plan emisji w <a href="/kontakt/#formularz" class="text-accent hover:underline">formularzu wyceny</a> - przygotujemy stawkę łączną.' },
    ...
    faqEn: [
      ...
      { q: 'Does one licence cover several stations?', a: 'The licence covers one station. For multi-station campaigns describe your media plan in the <a href="/en/contact/#contact-form" class="text-accent hover:underline">quote form</a>.' },
  ...
  },
  {
    ...
    metaDescriptionEn: 'Voice-over for online and social campaigns: up to 2 minutes, 12-month online/social licence. EUR 230 net.',
    ...
    feedTitle: 'Spot do kampanii internetowej - nagranie lektorskie do 2 minut + licencja 12 miesięcy',
  ...
  },
  {
    ...
    metaDescriptionEn: 'Narration for a film or presentation: 1 standard page (approx. 2 minutes), audio file or picture sync. EUR 110 net.',
    ...
    feedTitle: 'Narracja lektorska do filmu i prezentacji - 1 strona tekstu (ok. 2 min)',
  ...
  },
  {
    ...
    metaDescriptionEn: 'Narration for a film or presentation: 2 standard pages (approx. 4 minutes), audio file or picture sync. EUR 135 net.',
    ...
    feedTitle: 'Narracja lektorska do filmu i prezentacji - 2 strony tekstu (ok. 4 min)',
    ...
    faq: [
      { q: 'Mam 3 strony tekstu. Który pakiet wybrać?', a: 'Żaden - przy dłuższych tekstach stawka za stronę maleje, więc korzystniej wypełnić <a href="/kontakt/#formularz" class="text-accent hover:underline">formularz wyceny</a>. Odpowiadamy w 2 godziny w dni robocze.' },
      { q: 'Jak liczona jest strona znormalizowana?', a: '1 strona to 1800 znaków ze spacjami. Liczbę znaków sprawdzisz w każdym edytorze tekstu, np. w Wordzie w statystyce wyrazów. Do limitu liczymy tekst przeznaczony do nagrania.' },
    ...
    faqEn: [
      { q: 'I have 3 pages of script. Which package?', a: 'Neither - for longer scripts the per-page rate decreases, so the <a href="/en/contact/#contact-form" class="text-accent hover:underline">quote form</a> will get you a better price. We reply within 2 business hours.' },
      { q: 'How is a standard page counted?', a: 'One page is 1800 characters including spaces. You can check the count in any text editor, e.g. the word-count tool in Word. Only the script to be recorded counts towards the limit.' },
...
/* Pakiet 'Dogrywka / aktualizacja nagrania 24h' (290 zl netto) usuniety z oferty
   decyzja Pawla 06.07 ("to nie jest dobre na produkt") - wraca ewentualnie po
   przemysleniu formuly. Dane pakietu sa w historii gita (commit d976b49). */
const _REMOVED_DOGRYWKA = [
  {
...
PAKIETY.forEach(p => { p.brutto = brutto(p.netto); p.eur = eurCeil(p.netto); });
...
// Lektorzy do wyboru w zamowieniu pakietu (decyzja Pawla 06.07):
// - pakiety dwujezyczne PL+EN: WYLACZNIE imienna lista 13 lektorow nagrywajacych w obu jezykach,
// - pozostale pakiety: polscy lektorzy z nizszej grupy cenowej.
const BILINGUAL_PACKAGE_IDS = ['zapowiedzi-telefoniczne-pl-en', 'zapowiedzi-telefoniczne-max-pl-en'];
const BILINGUAL_VOICE_NAMES = ['Anita', 'Małgorzata', 'Konstancja', 'Dorota 3', 'Zuzanna', 'Marek 2', 'Janusz', 'Marcin 2', 'Krzysztof 2', 'Bartosz', 'Aleksander', 'Mateusz 3', 'Filip'];

function getOrderVoices(voices, pakiet) {
  const arr = voices.filter(v => v.approved !== false && v.id !== 'test-lektor');
  let pool;
  if (BILINGUAL_PACKAGE_IDS.includes(pakiet.id)) {
    const wanted = BILINGUAL_VOICE_NAMES.map(n => n.toLowerCase());
    pool = arr.filter(v => wanted.includes((v.name || '').trim().toLowerCase()));
  } else {
    pool = arr.filter(v => !v.hidePrice
      && (v.priceGroup || v.price || '').indexOf('Niższa') > -1
      && (v.languages || []).some(l => /polski/i.test(l)));
  }
  // Probka do odsluchu: najpierw pasujaca do kategorii pakietu, potem dowolna nie-obcojezyczna.
  const rx = SAMPLE_MATCH[pakiet.category] || SAMPLE_MATCH.narracja;
  return pool
    .sort((a, b) => a.name.localeCompare(b.name, 'pl'))
    .map(v => {
      const samples = (v.samples || []).filter(s => s && s.url);
      const sample = samples.find(s => rx.test(s.name || '') && !FOREIGN_SAMPLE.test(s.name || ''))
        || samples.find(s => !FOREIGN_SAMPLE.test(s.name || ''))
        || samples[0] || null;
      return {
        id: v.id,
        name: v.name,
        profileUrl: '/lektorzy/' + v.id + '/',
        sampleUrl: sample ? sample.url : null,
...
module.exports = { getAll, getBySlug, getBySlugEn, pickSamples, getOrderVoices, VAT };

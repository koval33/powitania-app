(function() {
  ...
  function renderServiceType() {
    ...
    html += '</div>';
    html += '<p class="mt-6 text-sm text-gray-500">Wolisz gotowy zestaw ze stałą ceną? Zobacz <a href="/sklep/" class="text-accent hover:underline font-medium">pakiety nagrań z cenami</a>.</p>';
